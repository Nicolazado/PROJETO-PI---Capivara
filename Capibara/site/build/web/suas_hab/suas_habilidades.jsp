...
<html>
    ...
    <head>
        <title>Suas Habilidades</title> <!-- Habilidades ja cadastradas -->
        <meta charset="UTF-8">
    ...
    <main style="background-image: url('../Folha.gif');background-position: center; height: 700px; background-size: 100% 100%;">
        ...
        <div class="texto">
            <%
                ...
                st = conecta.prepareStatement("SELECT * FROM suas_habilidades");
                ...
                out.print("<table >");
                out.print("<caption>Habilidades Registradas</caption>");
                out.print("<tr><th> Nome da habilidade</th><th> Usuário </th><th> horário disponivel </th><th>Excluir Habilidade</th><th>Alterar Habilidade</th></tr>");
                while (resultado.next()) {
                    out.print("<tr><td>" + resultado.getString("nome_hab") + "</td><td>" + resultado.getString("usuario") + "</td><td>" + resultado.getString("horario") + "</td>");
                ...
                out.print("<tr><td colspan='5'> <a class='tab' href=cadastro_hab.html> Cadastrar </td></tr>");
                out.print("</table>");
            %>
        </div>
    </main>
